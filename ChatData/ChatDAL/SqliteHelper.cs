...
namespace ChatData.ChatDAL
{
    public class SqliteHelper
    {
        ...
        {
            string strSqLiteConn = ConfigurationManager.ConnectionStrings["SqLiteConn"].ConnectionString;
            return new SQLiteConnection(strSqLiteConn);

         //  string strSqLiteApp = ConfigurationManager.AppSettings["SqLiteConn"].ToString();
